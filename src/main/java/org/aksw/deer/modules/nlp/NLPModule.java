...
import org.aksw.deer.helper.vocabularies.DBpedia;
import org.aksw.deer.helper.vocabularies.SCMSANN;
...
//	private static String FOX_SERVICE_URI = "http://sake.informatik.uni-leipzig.de:4444/call/ner/entities";
  ...
  public NLPModule(String fileNameOrUri, String literalPropartyUri) {
    super();
    this.model = (new Reader()).readModel(fileNameOrUri);
  ...
  public Model process(Model inputModel, Map<String, String> parameters) {
    ...
    if (parameters.containsKey("input")) {
      ...
      model = (new Reader()).readModel(inputFile);
    }
