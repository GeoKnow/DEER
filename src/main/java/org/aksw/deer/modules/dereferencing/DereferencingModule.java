...
public class DereferencingModule implements DeerModule{
    ...
    private static final Property DEFAULT_OUTPUT_PROPERTY = ResourceFactory.createProperty("http://geoknow.org/ontology/relatedTo");
    ...
    private static final String OUTPUT_PROPERTY_DESC = "The output property. By default this parameter is set to " + DEFAULT_OUTPUT_PROPERTY;
    ...
    private static final String RESOURCE_PREFIX_Desc = "Resource prefix used for dereferencing resources, by default is set to " + DEFAULT_RESOURCE_PREFIX;
            ...
            for (Statement triple : triplesWithURIsObjects){
                ...
                for (Property predicate : objectPredicateValuePairs.keySet()) {
                    for(RDFNode value : objectPredicateValuePairs.get(predicate)){
                        Property outputProperty = (i < outputProperties.size()) ? outputProperties.get(i) : DEFAULT_OUTPUT_PROPERTY;
                        if(value.isLiteral()){
