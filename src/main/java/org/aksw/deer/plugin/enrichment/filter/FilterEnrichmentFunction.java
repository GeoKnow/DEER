 ...
 *
 */
package org.aksw.deer.plugin.enrichment.filter;
 ...
 * @author sherif
 */
public class FilterEnrichmentFunction extends AEnrichmentFunction {
  ...
  private static final Logger logger = Logger.getLogger(FilterEnrichmentFunction.class.getName());
  ...
  public FilterEnrichmentFunction() {
    super();
  }
