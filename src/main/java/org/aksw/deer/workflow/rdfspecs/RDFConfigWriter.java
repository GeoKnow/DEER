...
public class RDFConfigWriter{
     ...
     * @author sherif
     */
    public Model changeModuleInputOutput(Model config, Resource moduleUri, Resource inputDatasetUri, Resource outputDatasetUri){
     ...
     * @author sherif
     */
    public Model changeInputDatasetUri(Model config, Resource moduleOrOperatorUri, Resource oldInputDatasetUri, Resource outputDatasetUri){
