...
public class RDFConfigWriter {
  ...
  /**
   * @return add configuration for the input module to the input configuration model, the returned
   * configuration model  is independent of the input configuration model
   * @author sherif
   */
  public Model addModule(DeerModule module, Map<String, String> parameters, final Model inputConfig,
   ...
   * @author sherif
   */
  public Model addOperator(DeerOperator operator, Map<String, String> parameters,
