...
//				specsModel.write(System.out,"TTL");
   ...
   * @author sherif
   */
  private static Map<String, String> generateRandomParameters(final DeerModule module,
  ...
  private static Map<String, String> authorityConformationModuleRandomParameter(
    ...
    parameters
      .put(AuthorityConformationModule.TARGET_SUBJET_AUTHORITY, "http://example.com/resource/");
    return parameters;
  }
