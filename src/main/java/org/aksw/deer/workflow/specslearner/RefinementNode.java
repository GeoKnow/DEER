...
public class RefinementNode implements Comparable<RefinementNode> {
   ...
   * @author sherif
   */
  private RefinementNode(DeerModule module, DeerOperator operator, double fitness,
    ...
    if (module != null && operator != null) {
      logger.error(
        "RefinementNodeX can contain either a module or an operator not both. Exit with error!");
      System.exit(1);
    }
    this.module = module;
...
//	}
   ...
   * @author sherif
   */
  public RefinementNode(DeerOperator operator, double fitness, List<Model> inputModels,
