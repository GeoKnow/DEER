...
public class SPECS {
  ...
  public static final Resource AuthorityConformationModule =
    resource("AuthorityConformationModule");
  public static final Resource PredicateConformationModule =
    resource("PredicateConformationModule");
