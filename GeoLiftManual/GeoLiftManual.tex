...
The following example introduces the command line execution of \geolift to enrich \texttt{example.ttl} with additional Geo-spatial data.
the \geolift command line read the input model from the configuration from a tape separated file \texttt{config.tsv}.
